...
fn run(window:&mut ViewerWindow,_path:&str)->Result<()>
{
    ...
    let controls=window.add_control_panel(&json!({"title":"CrsDatabase","controls":[

        {"id":2,"type":"number","label":"Code","minimum":1,"maximum":999999,"value":4326},
