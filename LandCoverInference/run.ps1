...
$Data = Get-SampleFile 'bilbao_s2_rgbnir_2021' 'bilbao_s2_rgbnir_2021.tif'
$manifest = Get-SampleFile 'landcover-bilbao-model' 'geokernel-model.json'
