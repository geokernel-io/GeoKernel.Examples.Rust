...
$Example = 'ScaleBasedLayerVisibility'
if (!$PrepareOnly) {
...
Test-Shapefile $Data
$StatesData = Get-SampleFile 'usa_states' 'usa_states.shp'
Test-Shapefile $StatesData
$CitiesData = Get-SampleFile 'usa_cities' 'usa_cities.shp'
Test-Shapefile $CitiesData
